  ...
  return (
    <div className="job-card">
      ...
      <div className="flex-item companyDetails">
        <img
          className=" flex-item companyIcon"
          src={logoUrl}
          alt={companyName}
        />
      ...
      <div className="flex-item salary">
        ...
        <div className="apply">
          {/* {minExp && (
            <>
              ...
              <div className="years">{minExp} years</div>
            </>
          )} */}
          <div className="exp">Minimum Experience</div>
          <div className="years">{minExp || 0} years</div>
...
export default connect(mapStateToProps)(React.memo(JobCard));
